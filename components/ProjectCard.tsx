        ...
        <div className="flex space-x-2 my-2">
          {project.techStack.map((tech) => (
            <img
              ...
              className="md:h-10 md:w-10 h-5 w-5 rounded-full "
              alt=""
            />
          ))}
        </div>
        <p className="uppercase py-5 text-slate-400">
          {project.dateStarted} to <span />
          {project.isOngoing ? <span> present</span> : project.dateEnded}
        </p>
